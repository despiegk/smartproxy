...
class UDPServerDebug(socketserver.UDPServer):
    allow_reuse_address = True
...
class TCPServerDebug(socketserver.TCPServer):
    allow_reuse_address = True
...
class DNSServer(object):
    ...
    def __init__(self, resolver,
        ...
        if not server:
            if tcp:
                if debug:
                    print("DNS TCP Server Debug")
                    server = TCPServerDebug
                else:
                    print("DNS TCP Server")
                    server = TCPServer
            else:
                if debug:
                    print("DNS UDP Server Debug")
                    server = UDPServerDebug
                else:
                    print("DNS UDP Server")
                    server = UDPServer
